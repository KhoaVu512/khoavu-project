...
function WhoFollow() {
  ...
  return (
    <div className="w-full bg-[#202327]  my-6 rounded-2xl hover:bg-light-600 ">
      <div className="mx-6 my-2 text-[20px] font-extrabold">Who to follow</div>
      <div className='flex justify-between mx-6'>
      <div className=' w-full h-[65.5px] hover:cursor-pointer'>
        <ItemWhoFollow 
        name='KhoaVu' nameTagUser='@khoavu_'/>
      </div>
      <div>
        <ButtonFollow />
      </div>
